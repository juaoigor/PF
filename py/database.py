...
def DedaConhecidos():
  ...
  db = sqlite3.connect(dbs)
  ## ALIMENTACAO PESSOAL
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%IFOOD%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%SODEXO%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%NUTRICAR%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%OLGA RI%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%LUGAR 166%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%RASCAL%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%SL CAFES DO%"')
  ## LIVING LAZER
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%IFOOD%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%OFNER%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%OFNER%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%TEMPERO DAS GERAIS%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%JOAKINS%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%BACIO DI LATTE%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%PASTEL%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%PASTEL%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%CUCINA%PIZZARIA%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%RASCAL%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%OURO CHOPP DDU%"')
  db.execute('UPDATE Despesas set id_conta = 9 where texto like "%PAGALECRISBEBIDAS%"')
  # LIVING MERCADO
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%SAMS%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%SAMS%DDU%"')
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%PAO DE ACUCAR%"')
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%ST%MARCHE%"')
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%CARNES%DAYT%"')
  db.execute('UPDATE Despesas set id_conta = 11 where texto like "%COMPANHIA BRASILEIRA%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%NUTRICAR%DDF%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%CARREFOUR%"')
  db.execute('UPDATE Despesas set id_conta = 5 where texto like "%MINUTO PA%"')
  # LIVING MENSAL
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%NETFLIX%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%APPLE%BILL%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%AMAZON%PRIME%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%AMAZON%DIGITAL%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%NETSERVICOS%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%CLAROMVEL%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%ENELSPELETROP%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%ANUIDADE DIFERENCIAD%"')
  db.execute('UPDATE Despesas set id_conta = 7 where texto like "%SEGURO CARTAO%"')
  # FILHOS PRESENTES
  db.execute('UPDATE Despesas set id_conta = 16 where texto like "%PBKIDS%"')
  db.execute('UPDATE Despesas set id_conta = 16 where texto like "%RI HAPPY%"')
  # SAUDE MENSAL
  ...
  db.execute('UPDATE Despesas set id_conta = 15 where texto like "%DROG%PAULO%"')
  # COMPRAS CASA
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%SODIMAC%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%WESTWING%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%LEROY%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%FAST SHOP%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%GALERIA9%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%LEO MADEIRAS%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%WW NOW%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%LA CASA DI M%"')
  ...
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%HOME DEC%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%RCHLO LOJA%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%BRASTEMP%"')
  db.execute('UPDATE Despesas set id_conta = 12 where texto like "%MMARTAN%"')
  #TRANSPORTE MENSAK
  db.execute('UPDATE Despesas set id_conta = 4 where texto like "%UBER%"')
  db.execute('UPDATE Despesas set id_conta = 4 where texto like "%ESTACIONAMENTO%"')
  db.execute('UPDATE Despesas set id_conta = 4 where texto like "%ESTAPAR%"')
  db.execute('UPDATE Despesas set id_conta = 4 where texto like "%AUTO POSTO%"')
  # LIVING FERIAS
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%GOL%AEREAS%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%TRAVEL PARTNER%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%PATACHOCAS%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%WINDSOR%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%AEROLINEAS%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%AG DE TURISMO%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%BRITISH AIRWAYS%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%PALACIO TANGARA%"')
  db.execute('UPDATE Despesas set id_conta = 10 where texto like "%BOOKING%"')
  #DEBUTO
  db.execute('UPDATE Despesas set id_conta = 9999 where texto like "%DEBITO%FATURA%CARTAO%"')
  db.execute('UPDATE Despesas set id_conta = 9999 where texto like "%DEB%FATURA%EM%"')
  ...
  dbs = 'db/database.db'
  db = sqlite3.connect(dbs)
  db.execute('UPDATE Contas set conta = "Receitas -> Salario -> Fixo" where ID = 1')
  db.execute('UPDATE Contas set conta = "Receitas -> Salario -> Variavel" where ID = 2')
  db.execute('UPDATE Contas set conta = "Investimentos -> Renda -> Investimentos" where ID = 3')
  db.commit()
  db.close()
  ...
  for l in r:
    if isDateVal(l['texto'][:8]):
      dt = datetime.datetime.strptime(l['texto'][:8], '%d/%m/%y').strftime("%y-%m-%d")
      st = '{}{}'.format(dt,l['texto'][8:])
      sql = 'UPDATE Despesas set texto = "{}" where id = {}'.format(st,l['id'])
      sqlExec(sql)
