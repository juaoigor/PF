...
# il = False
  ...
  for categoria in categorias:
    ...
    contas = sqlQuery("SELECT t3.Conta, t2.Risco FROM RiscosC t1, Riscos t2, Contas t3 where t1.idRisco = t2.id and t1.idConta = t3.id and t2.Categ  = '{}'".format(categoria['Categ']))
    for conta in contas:
