...
def geraRelatorio():
  ...
  id_comprascasa = df.index[df['Nome'] == 'Despesas -> Bens-> Compras'].tolist()[0]
  ...
  for c in df:
    if c != 'Nome' and c != 'Lvl' and c != 'ToSort':
      ...
      df.at[3002,c] = df.at[id_fixo,c] + df.at[2001,c] + df.at[4000,c]
      df.at[3003,c] = df.at[3002,c] - df.at[id_ferias,c] - df.at[id_educacao,c]
